...
public class ShortcutProviderGridTests
{
    ...
    public void FunctionApp_RunningIdleWithSlot_FullGrid()
    {
        ...
        // feat/app-settings-view: the Env vars shortcut (V) was added to the app panel grid.
        Assert.Equal(new ShortcutMap(ListPanelShortcuts.View, true), grid[new TableIndex(1, 5)]);
